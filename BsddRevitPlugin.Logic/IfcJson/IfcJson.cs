...
namespace BsddRevitPlugin.Logic.IfcJson
{
    ...
    /// <summary>
    /// IfcMaterialAssociation.
    /// </summary>
    public class IfcMaterialAssociation : Association
    {
    }
    public class IfcMaterial : IfcMaterialAssociation
    {
        /// <summary>
    ...
    public class IfcNormalisedRatioMeasure
    {
        ...
        public static implicit operator double(IfcNormalisedRatioMeasure measure)
        {
