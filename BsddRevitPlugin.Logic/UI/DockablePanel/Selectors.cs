...
namespace BsddRevitPlugin.Logic.UI.DockablePanel
{
    public class Select
    {
        ...
        public List<Element> AllElementsViewI(UIApplication uiapp)
        {
            //Select all elements in view
        ...
        public List<Element> AllElementsI(UIApplication uiapp)
        {
            //Select alle elementen in document
            List<Element> list = new List<Element>();
            UIDocument uidoc = uiapp.ActiveUIDocument;
        ...
        public List<Element> SelectElementsI(UIApplication uiapp)
        {
            //Select by selection
            List<Element> list = new List<Element>();
            UIDocument uidoc = uiapp.ActiveUIDocument;
