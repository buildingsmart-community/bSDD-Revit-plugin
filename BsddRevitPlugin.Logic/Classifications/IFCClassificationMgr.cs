...
namespace BsddRevitPlugin.Logic.Classifications
{
    public class IFCClassificationMgr
    {
        ...
        /// <summary>
        /// Update the IFC Classifications (from bSDD) into the document.
        /// </summary>
        /// <param name="document">The document storing the saved Classification.</param>
        /// <param name="classifications">The Classification items to save.</param>
        public static void UpdateClassifications(Document document, Transaction transaction, IList<IFCClassification> classifications)
        {
            Schema schema = GetSchema();
            if (schema != null)
            {
